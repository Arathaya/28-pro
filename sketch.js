...
function draw() {
  ...
  textAlign("center");
  textSize(40);
  text("EPIC ARCHERYy don don don", width / 2, 100);

  // Score
  fill("turquoise");
  textAlign("center");
  textSize(30);
  text("points :  " + score, width - 200, 100);

  // Arrow Count
  fill("turquoise");
  textAlign("center");
  textSize(30);
  text("no of Arrows lefty : " + numberOfArrows, 200, 100);
  ...
  swal(
    {
      ...
      imageSize: "150x150",
      confirmButtonText: "dare to Play Again"
    },
    function(isConfirm) {
      if (isConfirm) {
        location.reload();
